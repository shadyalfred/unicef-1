                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{ route('home') }}">
                        ...
                        <b>
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ asset('assets/images/unicef_logo.png') }}" alt="homepage" class="dark-logo" style="max-width: 40px"/>
                            <!-- Light Logo icon -->
                            <img src="{{ asset('assets/images/unicef_logo.png') }}" alt="homepage" class="light-logo" style="max-width: 40px"/>
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                    </a> 
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item right-side-toggle">
                            <a class="nav-link waves-effect waves-light" href="{{ route('switchLocale') }}">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Dashboard <span class="badge badge-pill badge-cyan ml-auto">4</span></span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="index2.html">Trading</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-bar-chart-alt"></i><span class="hide-menu">Reports</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="reports-capitalizations.html">Capitalizations</a></li>
                                <li><a href="reports-cryto-stats.html">Crypto Stats</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-people"></i><span class="hide-menu">Employees</span></a>
                            <ul aria-expanded="false" class="collapse">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-panel"></i><span class="hide-menu">ICO</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="ico-timeline.html">Timeline</a></li>
                                <li><a href="ico-listing.html">ICO Listing</a></li>
                            </ul>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="exchange.html" aria-expanded="false"><i class="fa fa-refresh"></i><span class="hide-menu">Currency Exchange</span></a></li>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="icon-login"></i><span class="hide-menu">Transactions</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="transaction-table.html">Trasaction Table</a></li>
                                <li><a href="transaction-listing.html">Trasaction Listing</a></li>
                                <li><a href="transaction-single.html">Trasaction Single</a></li>
                            </ul>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="tickers.html" aria-expanded="false"><i class="icon-pin"></i><span class="hide-menu">Tickers</span></a></li>
