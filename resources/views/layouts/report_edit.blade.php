...
@section('form-title', __('Edit Report'))

{{-- Breadcrumb --}}
@section('additional-breadcrumb')
    <li class="breadcrumb-item"><a href="#">@lang('Edit Report')</a></li>
@endsection
...
@section('form-content')
    ...
    <form id="spreadsheet-upload-form" action="@yield('form-action')" method="POST">
        @csrf
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="males_from_5_to_15" id="males_from_5_to_15" type="number" requried
                               ...
                               value="{{ $report->males_from_5_to_15 }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="females_from_5_to_15" id="females_from_5_to_15" type="number" requried
                               ...
                               value="{{ $report->females_from_5_to_15 }}">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input name="endangered_pregnancies" id="endangered_pregnancies" type="number" requried
                               ...
                               value="{{ $report->endangered_pregnancies }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input name="males_above_15_visits" id="males_above_15_visits" type="number" required
                               ...
                               value="{{ $report->males_above_15_visits }}">
...
@section('javascript')
    ...
    <script>
        ...
        const todaysDate = "{{ $report->date->format('m/Y') }}";
