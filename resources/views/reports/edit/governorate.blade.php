...
@section('page-title-breadcrumb', __('Edit Governorate Record'))

@section('form-action', route('reports.governorate.update', $report->id))

@section('form-subtitle', __('Edit Governorate Record'))
